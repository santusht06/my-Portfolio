    ...
    <>
      <div>
        <div className="lg:w-[750px] lg:h-250   bg-black rounded-3xl overflow-hidden relative lg:mt-40 mt-30  ">
          <div
            className="lg:h-full h-screen  lg:w-full rounded-3xl lg:px-16 lg:py-20  px-4 py-10  inner-shadow relative inset-0 z-20   "
            style={{
          ...
          >
            ...
            <div className="  ">
              ...
              <div className="absolute lg:right-15 right-5 bottom-10 lg:bottom-15 z-10  ">
